...
const ControlPanel = ({ selectedQuestion, updateQuestion, createQuestion, deleteQuestion, questions }) => {
  ...
  const exportApp = () => {
    ...
    const filename = 'notebookEmbed.txt';
      ...
      var blob = new Blob([embeddedAppText], { type: 'text/plain;charset=utf-8' });
  ...
  return (
    ...
    <hr></hr>
      ...
      <div>
      <label >Correct:</label>
      <input type="checkbox" checked={correct1} onChange={(e) => setCorrect1(e.target.checked)} />
      <hr></hr>
        </div>
      ...
      <div>
      <label >Correct:</label>
      <input type="checkbox" checked={correct2} onChange={(e) => setCorrect2(e.target.checked)} />
      <hr></hr>
      </div>
      ...
      <div>
      <label >Correct:</label>
      <input type="checkbox" checked={correct3} onChange={(e) => setCorrect3(e.target.checked)} />
      <hr></hr>
    </div>
    
      <label>Answer 4:</label>
      <input type="text" value={answer4} onChange={(e) => setAnswer4(e.target.value)} />
      <div>
      <label >Correct:</label>
      <input type="checkbox" checked={correct4} onChange={(e) => setCorrect4(e.target.checked)} />
    <hr></hr>  
</div>
